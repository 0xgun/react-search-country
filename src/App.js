          ...
          <Row className="justify-content-md-center">
            ...
            <Col xs="10">
              {/* <Alert variant="primary">
                { searchStatus === false ? <>Count of found countries : <Badge variant="primary">{numberSearchResult}</Badge></> : <><Spinner animation="border" variant="primary"></Spinner><span style={{
                  justifyContent: "center",
                  width: "80%",
                  margin: "auto",marginTop:"25px",  fontSize:'25px', textAlign:'center'}}> Searching...</span></> }
              </Alert> */}
              <Row className="justify-content-md-center">
                <Col xs="10">
